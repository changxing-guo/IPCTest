...
public class BindServieDemo1 extends Service {
    ...
    // 1、在service类中，创建一个满足以下任一要求的Binder实例
    class BinderDemo1 extends Binder {

        //返回当前Service实例，其中包含客户端可调用的公共方法
        protected BindServieDemo1 getServer() {

            return BindServieDemo1.this;
        }
     ...
     * 它是客户端用来和服务器进行交互的接口。而要得到IBinder接口，我们通常有三种方式：继承Binder类，使
     * 用Messenger类，使用AIDL。
     */
